...
%TODO: Tabellen Asynchronmaschine neu sortieren
\begin{longtable}[]{@{}ll@{}}
...
\begin{longtable}[]{@{}ll@{}}
\caption{Werte des Parameterrecords (\texttt{Machines.­Utilities.­Parameter­Records.­SM\_­ElectricalExcited­Data}) für den Synchron-Generator}\label{tab:ParameterRecordSG}
\tabularnewline
\toprule
Parameter & Wert\tabularnewline
\midrule
...
\begin{longtable}[]{@{}ll@{}}
\caption{Parameter des Modells des Synchron-Generators}\label{tab:ParameterSG}
\tabularnewline
\toprule
Parameter & Wert\tabularnewline
\midrule
...
\begin{longtable}[]{@{}ll@{}}
\caption{Parameter aus der Auslegung der Erregermaschine}\label{tab:AuslegungErregermaschine}
\tabularnewline
\toprule
Parameter & Wert\tabularnewline
\midrule
...
\begin{longtable}[]{@{}ll@{}}
\caption{Werte des Parameterrecords (\texttt{Machines.­Utilities.­Parameter­Records.­SM\_­ElectricalExcited­Data}) für den Synchro-Generator der Erregermaschine}\label{tab:ParameterRecordErregermaschine}
\tabularnewline
\toprule
Parameter & Wert\tabularnewline
\midrule
...
\begin{longtable}[]{@{}ll@{}}
\caption{Parameter des Synchro-Generators der Erregermaschine} \label{tab:ParameterErregermaschine}
\tabularnewline
\toprule
Parameter & Wert\tabularnewline
\midrule
