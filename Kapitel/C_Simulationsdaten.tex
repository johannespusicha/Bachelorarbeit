...
\bottomrule
\end{longtable}
%TODO: ASM Formeln/Symbole ergänzen
...
\begin{longtable}[]{@{}ll@{}}
\caption{Parameter des Modells des Synchron-Generators}
\label{tab:ParameterSG}
\tabularnewline
\toprule
Parameter & Wert\tabularnewline
\midrule
...
\begin{longtable}[]{@{}ll@{}}
\caption{Parameter aus der Auslegung der Erregermaschine}
\label{tab:AuslegungErregermaschine}
\tabularnewline
\toprule
Parameter & Wert\tabularnewline
\midrule
...
Erregermaschine}
\label{tab:ZwischenwerteErregermaschine}
\tabularnewline
\toprule
\begin{minipage}[b]{0.10\columnwidth}\raggedright
Parameter\strut
...
\label{tab:ParameterRecordErregermaschine}
\tabularnewline
\toprule
Parameter & Wert\tabularnewline
\midrule
...
Erregermaschine}
\label{tab:ParameterErregermaschine}
\tabularnewline
\toprule
Parameter & Wert\tabularnewline
\midrule
